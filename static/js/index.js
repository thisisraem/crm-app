...
$(document).ready(function () {
  ...
  function validateForm() {
    ...
    if (name && surname && gender && age && operatorCode && mobileNumber && location && store && email) {
  ...
  formInputs.forEach(input => {
    if (input.id === 'name' || input.id === 'surname') {
    ...
    } else if (input.id === 'age' || input.id === 'operator-code' || input.id === 'mobile-number') {
      input.addEventListener('input', function() {
      ...
      input.addEventListener('input', function() {
        validateInputEmailCharacters(input);
        validateForm();
      });
    }
  });
...
function validateInputEmailCharacters(input) {
